 ...
 function Menu() {
  ...
  return (
    <main className="animate-fade px-[5%] py-10 relative">
      ...
      {/* ================= MODAL ================= */}
      {selectedItem && (
        <div className="fixed pt-40 sm:pt-0 inset-0 z-50 bg-black/70 flex items-center justify-center px-4">
          <div className="bg-zinc-900 mt-20 rounded-2xl max-w-md w-full p-6 relative">
            <button
              onClick={() => {
            ...
            <h2 className="text-2xl font-bold mb-2 text-gray-100">{selectedItem.name}</h2>
            ...
            <div className="flex items-center gap-4 mb-4 text-gray-200 font-semibold">
              <button
                onClick={() =>
